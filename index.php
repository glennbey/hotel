    ...
    <div class="modal-dialog modal-md" role="document">
      ...
      <div class="modal-footer">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Hotel Mangement system | <a href="https://1sourcecodr.blogspot.com/" target="_blank">Glenn Bey</a></div></div>
        </footer>
